 ...
 */
class ExtensionUninstallDialog<T>(bundle: Bundle? = null) : DialogController(bundle)
        where T : Controller, T : ExtensionUninstallDialog.Listener {
    ...
    override fun onCreateDialog(savedViewState: Bundle?): Dialog {
        return MaterialDialog.Builder(activity!!)
                ...
                .onPositive { _, _ -> (targetController as? Listener)?.uninstallExtension(extension!!) }
                .build()
    }
